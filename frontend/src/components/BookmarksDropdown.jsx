...
export const BookmarksDropdown = () => {
    ...
    return (
        <div className="relative">
            {/* Bookmark Button with glass effect */}
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: -50 }}
                            className="fixed top-4 inset-x-4 md:top-8 md:inset-x-auto md:left-1/2 md:-translate-x-1/2 bg-black/90 backdrop-blur-xl rounded-2xl border border-white/10 p-6 z-50 w-full max-w-3xl shadow-2xl"
                        >
